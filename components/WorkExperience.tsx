  ...
  return (
    <div className="skill-container hidden landscape:max-h-[500px]:lg:block lg:block portrait:md:block">
      ...
      >
        ...
        <div className="w-full flex s8:mt-20 12pro:mt-16 space-x-5 overflow-x-scroll p-10 snap-x snap-mandatory scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#D1FE17]/80">
